...
import { Plus, Lock, ArrowRight, Loader2, CheckCircle2 } from "lucide-react";
          ...
          {success ? (
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-black">Password Updated</h3>
                <p className="text-sm font-bold text-[#64748B]">You can now login with your new password.</p>
              </div>
            ...
            <form onSubmit={handleReset} className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-[#94A3B8] uppercase tracking-[0.2em] ml-4">New Password</label>
                <div className="relative group">
                  ...
                  <input 
                    ...
                    placeholder="••••••••"
                    className="w-full bg-white border-2 border-[#F1F5F9] rounded-2xl py-4 pl-14 pr-6 font-black text-[#0F172A] focus:border-[#0D9488] focus:ring-4 focus:ring-[#0D9488]/5 transition-all outline-none"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-[#94A3B8] uppercase tracking-[0.2em] ml-4">Confirm New Password</label>
                <div className="relative group">
                  <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-[#94A3B8] group-focus-within:text-[#0D9488] transition-colors" size={20} />
                  <input 
                    type="password" 
